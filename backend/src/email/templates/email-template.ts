 ...
 * 
 * Provides standardized email templates with JCoder branding
 * based on the frontend design system
 */
...
export class EmailTemplate {
    ...
    static generateHTML(options: EmailTemplateOptions): string {
        const {
            title,
            content,
            footerText = 'This is an automatic notification from the JCoder system. Please do not reply to this email directly.',
            logoUrl,
            frontendBaseUrl,
        } = options;

        // Logo image - if logoUrl is provided, use it, otherwise use inline CID or placeholder
...
${footer}
    ...
    /**
     * Creates a code box for verification codes
     */
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 30px 0;">
    ...
    /**
     * Creates a message box for displaying messages
     */
...
${message.replace(/\n/g, '<br>')}
    ...
    /**
     * Creates a button/link styled as a button
     */
