...
let CheckUsernameAvailabilityUseCase = class CheckUsernameAvailabilityUseCase {
    constructor(userRepository) {
        this.userRepository = userRepository;
    }
    async execute(username) {
        if (!username || username.length < 3) {
            return (0, class_transformer_1.plainToInstance)(check_username_availability_dto_1.CheckUsernameAvailabilityDto, {
                available: false,
                username,
            });
        }
...
exports.CheckUsernameAvailabilityUseCase = CheckUsernameAvailabilityUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_2.InjectRepository)(user_entity_1.User)),
    __metadata("design:paramtypes", [typeorm_1.Repository])
], CheckUsernameAvailabilityUseCase);
;
//# sourceMappingURL=check-username-availability.use-case.js.map