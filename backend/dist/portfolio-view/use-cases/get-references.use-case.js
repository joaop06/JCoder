...
let GetReferencesUseCase = class GetReferencesUseCase {
    constructor(cacheService, userRepository, referenceRepository) {
    ...
    async execute(username, paginationDto) {
        ...
        const cacheKey = this.cacheService.generateKey('portfolio', 'references', username, page, limit, validatedSortBy, sortOrder);
        ...
        return (0, class_transformer_1.plainToInstance)(get_references_dto_1.GetReferencesDto, result);
    }
};
...
exports.GetReferencesUseCase = GetReferencesUseCase = __decorate([
    ...
    __param(2, (0, typeorm_2.InjectRepository)(user_component_reference_entity_1.UserComponentReference)),
    __metadata("design:paramtypes", [cache_service_1.CacheService,
        typeorm_1.Repository,
        typeorm_1.Repository])
], GetReferencesUseCase);
;
//# sourceMappingURL=get-references.use-case.js.map