...
let GetCertificatesUseCase = class GetCertificatesUseCase {
    constructor(cacheService, userRepository, certificateRepository) {
    ...
    async execute(username, paginationDto) {
        ...
        const cacheKey = this.cacheService.generateKey('portfolio', 'certificates', username, page, limit, validatedSortBy, sortOrder);
        ...
        return (0, class_transformer_1.plainToInstance)(get_certificates_dto_1.GetCertificatesDto, result);
    }
};
...
exports.GetCertificatesUseCase = GetCertificatesUseCase = __decorate([
    ...
    __param(2, (0, typeorm_2.InjectRepository)(user_component_certificate_entity_1.UserComponentCertificate)),
    __metadata("design:paramtypes", [cache_service_1.CacheService,
        typeorm_1.Repository,
        typeorm_1.Repository])
], GetCertificatesUseCase);
;
//# sourceMappingURL=get-certificates.use-case.js.map