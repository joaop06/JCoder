...
exports.UploadTechnologyProfileImageUseCase = void 0;
...
let UploadTechnologyProfileImageUseCase = class UploadTechnologyProfileImageUseCase {
    ...
    async execute(id, file) {
        ...
        if (technology.profileImage) {
            await this.imageStorageService.deleteImage(resource_type_enum_1.ResourceType.Technology, id, technology.profileImage, undefined, technology.user.username);
        }
        const filename = await this.imageStorageService.uploadImage(file, resource_type_enum_1.ResourceType.Technology, id, image_type_enum_1.ImageType.Profile, undefined, technology.user.username);
        technology.profileImage = filename;
        return await this.technologyRepository.save(technology);
    }
};
exports.UploadTechnologyProfileImageUseCase = UploadTechnologyProfileImageUseCase;
exports.UploadTechnologyProfileImageUseCase = UploadTechnologyProfileImageUseCase = __decorate([
...
;
//# sourceMappingURL=upload-technology-profile-image.use-case.js.map