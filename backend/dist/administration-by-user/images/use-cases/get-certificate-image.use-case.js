...
exports.GetCertificateImageUseCase = void 0;
...
let GetCertificateImageUseCase = class GetCertificateImageUseCase {
    constructor(imageStorageService, certificateRepository) {
        this.imageStorageService = imageStorageService;
        this.certificateRepository = certificateRepository;
    }
    async execute(username, certificateId) {
        ...
        return await this.imageStorageService.getImagePath(resource_type_enum_1.ResourceType.User, certificateId, certificate.profileImage, 'certificates', certificate.user.username);
    }
};
exports.GetCertificateImageUseCase = GetCertificateImageUseCase;
exports.GetCertificateImageUseCase = GetCertificateImageUseCase = __decorate([
...
;
//# sourceMappingURL=get-certificate-image.use-case.js.map