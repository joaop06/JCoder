...
exports.GetProfileImageUseCase = void 0;
...
let GetProfileImageUseCase = class GetProfileImageUseCase {
    ...
    async execute(id) {
        ...
        return await this.imageStorageService.getImagePath(resource_type_enum_1.ResourceType.Application, id, application.profileImage, undefined, application.user.username);
    }
};
exports.GetProfileImageUseCase = GetProfileImageUseCase;
exports.GetProfileImageUseCase = GetProfileImageUseCase = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [images_service_1.ImagesService,
        image_storage_service_1.ImageStorageService])
], GetProfileImageUseCase);
;
//# sourceMappingURL=get-profile-image.use-case.js.map