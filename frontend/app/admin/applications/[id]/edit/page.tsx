            ...
            <div className="min-h-screen flex flex-col bg-gray-50">
                ...
                <main className="flex-1 container mx-auto px-4 py-12">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Loading Application...</h1>
                        <p className="text-gray-600">Please wait while we load the application details.</p>
                    </div>
                </main>
                <Footer />
            </div>
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <main className="flex-1 container mx-auto px-4 py-12">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Edit Application</h1>
                        <p className="text-gray-600">Edit the details of your application</p>
                    </div>
