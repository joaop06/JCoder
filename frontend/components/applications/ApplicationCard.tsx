...
export default function ApplicationCard({ application, username }: ApplicationCardProps) {
  ...
  return (
    <div className="bg-jcoder-card border border-jcoder rounded-lg p-3 sm:p-4 md:p-6 hover:shadow-lg hover:shadow-jcoder-primary/20 transition-all duration-300 hover:border-jcoder-primary">
      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
        ...
        {application.profileImage && appUsername ? (
          ...
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-jcoder-gradient rounded-lg flex items-center justify-center flex-shrink-0">
            <span className="text-black font-bold text-base sm:text-lg">{getInitial(application.name)}</span>
          </div>
        )}
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs sm:text-sm text-jcoder-muted mb-3 sm:mb-4 line-clamp-2">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
            {appUsername ? (
              <Link
                ...
                className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm border border-jcoder rounded-lg hover:bg-jcoder-secondary hover:border-jcoder-primary transition-colors text-jcoder-muted hover:text-white"
              >
            ...
            {componentUrl && (
              <a
                ...
                className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm bg-jcoder-gradient text-black rounded-lg hover:opacity-90 transition-opacity font-medium"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
